...
Создание IDEF0-диаграммы "Документирование программного кода" в RAMUS (программное средство разработки структурно-функциональных моделей). 
...
+ Диаграмма классов и [код для её построения]():
...
+ Диаграмма прецедентов и [код для её построения]():
